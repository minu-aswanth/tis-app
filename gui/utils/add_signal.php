...
function add_signal(){
	try {
		...
		$link = linkToTIS();
		$handle=$link->prepare("INSERT INTO `utmc_traffic_signal_static`(`SCN`, `IPAddress`, `GroupID`, `Group_SCN`, `ShortDescription`, `LongDescription`, `Supplier`, `Latitude`, `Longitude`, `NumLinks`,`SignalOffset`) VALUES ('$scn','$ip','$signal_group','$group_scn','$short_desc','$long_desc','$supplier','$lat','$lng','$num_links','$offset')");
		$handle->execute();
